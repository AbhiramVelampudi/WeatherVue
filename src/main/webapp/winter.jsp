    ...
    <style>
      ...
      <div class="my-card-grid">
        <a href="https://www.tripadvisor.in/Tourism-g187147-Paris_Ile_de_France-Vacations.html" alt="Mythrill" target="_blank" class="my-card-container">
          <div class="card">
            <div class="wrapper">
              <img src="img/winter/hp.jpg" class="cover-image" />
            </div>
            <img src="img/winter/hptxt.png" class="title" />
            <img src="img/winter/hpp.png" class="character" />
          </div>
        </a>
        <a href="https://www.tripadvisor.in/Tourism-g294226-Bali-Vacations.html" alt="Mythrill" target="_blank" class="my-card-container">
            <div class="card">
              <div class="wrapper">
                <img src="img/winter/gl.jpg" class="cover-image" />
              </div>
              <img src="img/winter/gltxt.png" class="title" />
              <img src="img/winter/gll.png" class="character" />
            </div>
          </a>
          <a href="https://www.tripadvisor.in/Tourism-g28932-Hawaii-Vacations.html" alt="Mythrill" target="_blank" class="my-card-container">
            <div class="card">
              <div class="wrapper">
                <img src="img/winter/hawai.jpg" class="cover-image" />
              </div>
              <img src="img/winter/hawaitxt.png" class="title" />
              <img src="img/winter/hawaii.png" class="character" />
            </div>
          </a>
          <a href="https://www.tripadvisor.in/Tourism-g1722390-Cape_Town_Western_Cape-Vacations.html" alt="Mythrill" target="_blank" class="my-card-container">
            <div class="card">
              <div class="wrapper">
                <img src="img/winter/maldives.jpg" class="cover-image" />
              </div>
              <img src="img/winter/maldivestxt.png" class="title" />
              <img src="img/winter/maldivess.jpg" class="character" />
            </div>
          </a>
          <a href="https://www.cometoparis.com/paris-guide/what-to-do-in-paris-s938" alt="Mythrill" target="_blank" class="my-card-container">
            <div class="card">
              <div class="wrapper">
                <img src="img/winter/vi.jpg" class="cover-image" />
              </div>
              <img src="img/winter/vitxt.png" class="title" />
              <img src="img/winter/vii.png" class="character" />
            </div>
          </a>
